    ...
    <AdminShell>
      <AdminContent>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-foreground">Timetable Import</h1>
            <p className="text-sm text-muted-foreground mt-1">Import schedules from external systems.</p>
          </div>
        ...
        <div className="rounded-xl border border-border bg-card p-10 text-center shadow-sm">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-muted-foreground">This tool is being redesigned.</p>
        </div>
      </AdminContent>
    </AdminShell>
  )
